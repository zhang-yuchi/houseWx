...
Page({
  ...
  data: {
    ...
    firstLevel: [{
        name: "电视",
        url: "../../images/dianshi.png",
        prop: "hasTelevison",
        id: 0,
        selected: false,
        className: "jjBox_son_text"
      },
      {
        name: "冰箱",
        url: "../../images/bingxiang.png",
        prop: "hasRefrigerator",
        id: 1,
        selected: false,
        className: "jjBox_son_text"
      },
                  ...
                  wx.openSetting({
                    success: function (data) {
                      if (data.authSetting['scope.userLocation'] === true) {
                        ...
                        wx.reLaunch({
                          url: './housedetail?obj='+options.obj,
                        })
                      }
                    }
                  })
